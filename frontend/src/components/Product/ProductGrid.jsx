...
function ProductGrid({ searchTerm, category, subCategory, onDataLoaded }) {
    ...
    // Reset page to 0 when category, subCategory, or searchTerm changes
    useEffect(() => {
        setPage(0);
    ...
    useEffect(() => {
        ...
        fetchData();
    }, [page, size, searchTerm, category, subCategory, onDataLoaded]);
